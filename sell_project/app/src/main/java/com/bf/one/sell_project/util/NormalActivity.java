...
import com.bf.one.sell_project.MainActivity;
import com.bf.one.sell_project.R;
import com.bf.one.sell_project.logo;
...
//        .setRationaleMessage(R.string.rationale_message)
        ...
        .setPermissions(Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_WIFI_STATE)
        .check();
