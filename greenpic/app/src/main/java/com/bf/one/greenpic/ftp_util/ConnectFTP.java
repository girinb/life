package com.bf.one.greenpic.ftp_util;

import android.util.Log;

import com.bf.one.greenpic.MainActivity;
...
//                File delfile = new File(srcFilePath + desFileName);
//                delfile.delete();
            }
            fis.close();
        } catch (Exception e) {
            Log.d(TAG, "Couldn't upload the file" + e.toString());
        }
        return result;
    }
...
//        mFTPClient.setControlEncoding("eur-kr or utf-8");
        ...
        mFTPClient.setConnectTimeout(24 * 60 * 60 * 1000);
