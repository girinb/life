...
import com.bf.one.myapmp3.ui.MusicPlayerActivity;
import com.bf.one.myapmp3.utils.LogHelper;
import com.bf.one.myapmp3.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private static final String CHANNEL_ID = "com.bf.one.myapmp3.MUSIC_CHANNEL_ID";

    private static final int NOTIFICATION_ID = 412;
    private static final int REQUEST_CODE = 100;

    public static final String ACTION_PAUSE = "com.bf.one.myapmp3.pause";
    public static final String ACTION_PLAY = "com.bf.one.myapmp3.play";
    public static final String ACTION_PREV = "com.bf.one.myapmp3.prev";
    public static final String ACTION_NEXT = "com.bf.one.myapmp3.next";
    public static final String ACTION_STOP = "com.bf.one.myapmp3.stop";
    public static final String ACTION_STOP_CASTING = "com.bf.one.myapmp3.stop_cast";
